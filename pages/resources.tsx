...
export default function Resources() {
  ...
  return (
    <>
      ...
      <NextSeo
        title="Resources"
        description="Learn how to set up your wallet, browse through the platform, and purchase your first piece of digital clothing."
        canonical="https://www.thefashionverse.io/resources/"
        twitter={{
